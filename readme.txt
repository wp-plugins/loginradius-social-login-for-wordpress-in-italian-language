...
Note: Abbiamo spostato questo plug-in con langugae italiano per http://wordpress.org/extend/plugins/loginradius-for-wordpress/. Si prega di utilizzare la versione aggiornata del plug-in in lingua italiana per implementare login Socail.
...
8. Accedere alla sezione "Impostazioni" e cliccate sulla voce "LoginRadius" dove andremo ad inserire l'API key e l'API Secret.
9. Cliccate sul link LoginRadius (o collegatevi al sito www.loginradius.com) per ottenere l'API key e l'API Secret. Effettuate il login usando qualsiasi account social. 

- Inserite l'url assoluto del vostro sito (esempio: http://www.nome_sito.it) e l'url della pagina da visualizzare dopo che un utente ha effettuato l'accesso (esempio: http://www.nome_sito.it/benvenuto.html). 
- Selezionate i social login da inserire nel widget, spuntando le relative caselle.
- Infine cliccate su "Save and get code".
...
Se avete domande o dubbi riguardanti LoginRadius, scrivere a hello@loginradius.com.
